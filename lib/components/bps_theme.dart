...
class BpsTheme {
  ...
  /// Mengambil tema yang dijadwalkan secara otomatis berbasis kalender BPS
  static ActivityTheme autoScheduledTheme({DateTime? customDate}) {
  ...
  static ActivityTheme current({BpsActivity? activity, DateTime? customDate}) {
    ...
    return autoScheduledTheme(customDate: customDate);
  }
